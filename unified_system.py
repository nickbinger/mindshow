#!/usr/bin/env python3
"""
Unified MindShow System
Web Dashboard + GUI + LED Control with Real Muse Data
All components synchronized with the same brainwave data
"""
...
class UnifiedBrainwaveAnalyzer:
    """Unified real-time brainwave analysis"""
...
class UnifiedGUI:
    """Unified GUI for brain state display"""
    
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("🧠 MindShow Unified System")
    ...
    def setup_gui(self):
        """Setup the unified GUI"""
        # Main title
        title_label = tk.Label(
            self.root, 
            text="🧠 MindShow Unified System", 
            font=("Arial", 16, "bold"),
            bg='#2c3e50',
            fg='white'
        )
...
async def main_loop():
    ...
    brain_analyzer = UnifiedBrainwaveAnalyzer()
    ...
    gui.set_status("System Ready - Processing brainwaves...", '#2ecc71')
...
if __name__ == "__main__":
    ...
    logger.info("Starting MindShow Unified System...")
